...
class FileStore(AbstractStore):
    ...
    def _create_experiment_with_id(self, name, experiment_id, user_id, artifact_uri):
        artifact_uri = artifact_uri or append_to_uri_path(
            self.artifact_root_uri, str(experiment_id)
        )
        self._check_root_dir()
        meta_dir = mkdir(self.root_directory, str(experiment_id))
        experiment = Experiment(experiment_id, name, artifact_uri, LifecycleStage.ACTIVE, user_id=user_id)
    ...
    def create_experiment(self, name, user_id, artifact_location=None):
        self._check_root_dir()
        ...
        return self._create_experiment_with_id(name, str(experiment_id), user_id, artifact_location)
